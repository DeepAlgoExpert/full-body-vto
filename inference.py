...
def parse_args():
    ...
    parser.add_argument("--batch_size", type=int, default=3, help="Batch size to use.")
    ...
    parser.add_argument('--dresscode_dataroot', type=str, default="./input", help='DressCode dataroot')
    ...
    parser.add_argument("--dataset", type=str, default="dresscode", choices=["dresscode", "vitonhd"], help="dataset to use")
    parser.add_argument("--category", type=str, choices=['all', 'lower_body', 'upper_body', 'dresses'], default='dresses')
